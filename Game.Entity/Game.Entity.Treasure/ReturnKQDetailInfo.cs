...
namespace Game.Entity.Treasure
{
	...
	public class ReturnKQDetailInfo
	{
		...
		private System.DateTime m_payDate;
		public int DetailID
		{
			get
			{
		...
		public ReturnKQDetailInfo()
		{
			...
			this.m_bankID = "";
			this.m_orderID = "";
			this.m_orderTime = System.DateTime.Now;
			this.m_orderAmount = 0m;
			this.m_dealID = "";
			this.m_bankDealID = "";
			this.m_dealTime = System.DateTime.Now;
			this.m_payAmount = 0m;
			this.m_fee = 0m;
			this.m_payResult = "";
			this.m_errCode = "";
			...
			this.m_payDate = System.DateTime.Now;
		}
	}
}
