...
namespace Game.Entity.GameMatch
{
	...
	public class StreamMatchHistory
	{
		...
		private System.DateTime m_matchStartTime;
		private System.DateTime m_matchEndTime;
		private int m_playTimeCount;
		private int m_onlineTime;
		private string m_machine;
		private string m_clientIP;
		private System.DateTime m_recordDate;
		public int ID
		{
			get
			{
		...
		public StreamMatchHistory()
		{
			...
			this.m_drawCount = 0;
			this.m_fleeCount = 0;
			this.m_matchStartTime = System.DateTime.Now;
			this.m_matchEndTime = System.DateTime.Now;
			this.m_playTimeCount = 0;
			this.m_onlineTime = 0;
			this.m_machine = "";
			this.m_clientIP = "";
			this.m_recordDate = System.DateTime.Now;
		}
	}
}
