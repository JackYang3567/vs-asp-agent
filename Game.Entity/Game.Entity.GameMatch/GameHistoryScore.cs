...
namespace Game.Entity.GameMatch
{
	...
	public class GameHistoryScore
	{
		...
		public System.DateTime HBackupTime
		{
			get
			{
		...
		public System.DateTime NBackupTime
		{
			get
			{
		...
		public GameHistoryScore()
		{
			...
			this.m_hDrawCount = 0;
			this.m_hFleeCount = 0;
			this.m_hBackupTime = System.DateTime.Now;
			this.m_nScore = 0L;
			this.m_nWinCount = 0;
			this.m_nLostCount = 0;
			this.m_nDrawCount = 0;
			this.m_nFleeCount = 0;
			this.m_nBackupTime = System.DateTime.Now;
		}
	}
}
