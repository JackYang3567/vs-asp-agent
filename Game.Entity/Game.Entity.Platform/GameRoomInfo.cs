...
namespace Game.Entity.Platform
{
	...
	public class GameRoomInfo
	{
		...
		private System.DateTime m_createDateTime;
		private System.DateTime m_modifyDateTime;
		...
		public string ServerPasswd
		{
			get
			{
				return this.m_serverPasswd;
			}
			set
			{
				this.m_serverPasswd = value;
			}
		}
		...
		public string EnterPassword
		{
			get
			{
				return this.m_enterPassword;
			}
			set
			{
				this.m_enterPassword = value;
			}
		}
		public GameRoomInfo()
		{
			...
			this.m_nullity = 0;
			this.m_serverNote = "";
			this.m_createDateTime = System.DateTime.Now;
			this.m_modifyDateTime = System.DateTime.Now;
			this.m_enterPassword = "";
		}
	}
}
