...
namespace Game.Entity.NativeWeb
{
	...
	public class GameFeedbackInfo
	{
		...
		public System.DateTime RevertDate
		{
			get
			{
		...
		public GameFeedbackInfo()
		{
			...
			this.m_feedbackDate = System.DateTime.Now;
			this.m_userID = 0;
			this.m_clientIP = "";
			this.m_viewCount = 0;
			this.m_revertUserID = 0;
			this.m_revertContent = "";
			this.m_revertDate = System.DateTime.Now;
			this.m_nullity = 0;
