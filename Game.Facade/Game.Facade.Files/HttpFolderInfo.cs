...
namespace Game.Facade.Files
{
	public class HttpFolderInfo
	{
		...
		public string FormatModifyDate
		{
			get
			{
				return System.DateTime.Parse(this.m_modifyDate.ToString("U")).AddHours(8.0).ToString("yyyy-MM-dd hh:mm:ss");
			}
		}
		public HttpFolderInfo()
		{
		}
		public HttpFolderInfo(string p_name, string p_fullName, string p_formatName, string p_ext, long p_size, string p_type, System.DateTime p_modifyDate)
		{
			this.m_name = p_name;
