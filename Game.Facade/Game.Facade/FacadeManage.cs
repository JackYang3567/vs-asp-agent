...
namespace Game.Facade
{
	public class FacadeManage
	{
		...
		public static PlatformManagerFacade aidePlatformManagerFacade
		{
			get
			{
				if (FacadeManage._aidePlatformManagerFacade == null)
				{
					lock (FacadeManage.lockObj)
					{
						if (FacadeManage._aidePlatformManagerFacade == null)
						{
							FacadeManage._aidePlatformManagerFacade = new PlatformManagerFacade();
						}
					}
				}
				return FacadeManage._aidePlatformManagerFacade;
			}
		}
